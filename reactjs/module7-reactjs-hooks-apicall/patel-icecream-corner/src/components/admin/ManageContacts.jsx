     ...
     <table className='table-auto text-center w-full mt-10 border-1 border-separate border-spacing-[26px]'>
        ...
        {contactdata && contactdata.map((item)=>{
          return(
            ...
            <td><button type='button' onClick={()=>navigate(`/admin-login/delete-contact/${item.id}`)} className='bg-red-600 text-white p-3'><span className='bi bi-trash'></span></button></td>
        </tr>
