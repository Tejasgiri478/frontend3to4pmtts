  ...
  return (
   <>
     <div className='w-3/4 bg-white shadow mx-auto mt-10 p-2'>
      <h1 className='text-center text-6xl font-mono'>Admin Login</h1>
      ...
      <div className='flex flex-row mt-0 p-10'>
        ...
        <div className='w-1/2'>
            <form>
                ...
                <div className='form-group mt-5'>
                    <input type='submit'  className='form-control w-full p-4 border-1 bg-black text-white text-2xl font-mono' value="Login" />
                </div>
            </form>
        </div>
      </div>
